...
var ProductModel = /** @class */ (function () {
    ...
    ProductModel.prototype.updateProduct = function (product, idCloud) {
        return __awaiter(this, void 0, void 0, function () {
            var imageHeaderCleaned, startPosition, imageExtension, imageContent, params;
            return __generator(this, function (_a) {
                ...
                if (product.imagem) {
                    ...
                    params.Produto[0].imagemnome = "prod-".concat(product.codInterno, ".").concat(imageExtension);
...
//# sourceMappingURL=sysProducts.js.map