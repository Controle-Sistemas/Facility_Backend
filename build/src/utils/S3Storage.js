...
var S3Storage = /** @class */ (function () {
    ...
    S3Storage.prototype.saveFile = function (filename, route) {
        return __awaiter(this, void 0, void 0, function () {
            var originalPath, ContentType, fileContent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        originalPath = path_1.default.resolve(multer_1.default.dest, filename);
                    ...
                    case 1:
                        ...
                        this.client.putObject({
                            Bucket: "controlesistemasupload/".concat(route),
                            Key: filename,
                            Body: fileContent,
                            ACL: "public-read",
    ...
    S3Storage.prototype.deleteFile = function (filename, folder) {
        return __awaiter(this, void 0, void 0, function () {
            var objectBucket, finalFileName, objectkey;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        objectBucket = "controlesistemasupload/".concat(folder);
                        finalFileName = filename.includes('+') ? filename.replace(/[+]/g, ' ') : filename;
                        objectkey = "".concat(finalFileName);
                        console.log('Bucket:', objectBucket);
                        console.log('Key:', objectkey.replace(',', ''));
                        return [4 /*yield*/, this.client.deleteObject({
                                Bucket: objectBucket,
