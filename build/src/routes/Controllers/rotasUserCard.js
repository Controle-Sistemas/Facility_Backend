...
var userCardModel_1 = __importDefault(require("../../db/Models/userCardModel"));
...
routes.get('/user/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id;
    return __generator(this, function (_a) {
        id = Number(req.params.id);
